<div class="row">
			...
			<div class="row">
				...
				<div class="box-header">
				  <h3 class="box-title">Data Table With the expenses category information</h3>
				</div>
				<!-- /.box-header -->
				<div class="box-body">
				  <table id="example2" class="table table-bordered table-striped">
					...
					<tbody>
					<?php foreach($this->data['listexpensescategory'] as $row){ ?>
					<tr>
					  <td><?php echo $row->id ?></td>
					  <td><?php echo $row->name ?></td>
					  <td align="center">
						<a href="expensescategory/edit/<?php echo $row->id ?>"><button type="button" class="btn btn-danger"><i class="fa fa-edit"></i></button></a>
						<a href="expensescategory/del/<?php echo $row->id ?>"><button type="button" class="btn btn-warning"><i class="fa fa-times-circle"></i></button></a>
					  </td>
					</tr>
					<?php } ?>
					</tbody>
