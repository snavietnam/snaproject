            ...
            <div class="col-md-12">
                <div class="main-header">
					...
					<div class="col-lg-6  align-right">
						<div class="col-lg-6">
						<a href="typeaccount/add"><button type="button" class="btn btn-block btn-info btn-sm">ADD CUSTOMER</button></a>
						</div>
					</div>
					<script>
				...
				<div class="box-body">
				  <table id="example2" class="table table-bordered table-striped">
					...
					<tr>
					  ...
					  <td align="center">
						<a href="typeaccount/edit/<?php echo $row->id ?>"><button type="button" class="btn btn-danger"><i class="fa fa-edit"></i></button></a>
						<a href="typeaccount/del/<?php echo $row->id ?>"><button type="button" class="btn btn-warning"><i class="fa fa-times-circle"></i></button></a>
					  </td>
					</tr>
					<?php } ?>
					</tbody>
