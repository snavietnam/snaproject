			...
			<div class="row">
				...
				<div class="box-body"">
				  <table id="example2" class="table table-bordered table-striped">
					...
					<tbody>
					<?php foreach($this->data['listexpensestype'] as $row){ ?>
					<tr>
					  <td><?php echo $row->id ?></td>
					  <?php foreach($this->data['listexpensescategory'] as $row1){if($row->id_category == $row1->id){ ?>
						<td><?php echo $row1->name ?></td>
					  <?php }} ?>
					  <td><?php echo $row->name ?></td>
					  <td align="center">
						<a href="expensestype/edit/<?php echo $row->id ?>"><button type="button" class="btn btn-danger"><i class="fa fa-edit"></i></button></a>
						<a href="expensestype/del/<?php echo $row->id ?>"><button type="button" class="btn btn-warning"><i class="fa fa-times-circle"></i></button></a>
					  </td>
					</tr>
					<?php } ?>
					</tbody>
